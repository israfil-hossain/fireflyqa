...
const Banner = ({title,subtitle,banner,pageName}:{title:string, subtitle:string, banner:any, pageName:string}) => {
  return (
      ...
      <div className="flex flex-col w-full lg:flex-row lg:items-start items-center justify-between ">
        ...
        >
          <div className="relative  w-full flex justify-end ">
           <Image src={banner} alt="hero" width={500} height={500} className=""/>
           </div>
